...
tout en préservant le prompt caching et en empêchant la perte brutale de contexte.
"""
...
class ContextManager:
    ...
    3. Faits sémantiques & Préférences actifs (LessonStore / Facts)
    4. Timeline Index (Index chronologique léger du passé lointain)
    5. Messages récents verbatim (Mémoire de travail immédiate)
    """
    ...
    def assemble_orchestrator_context(
        ...
        """
        # 1. Évaluer et formater les faits/préférences
        ...
        # 2. Timeline Index (échanges anciens)
        ...
        # 3. Messages récents verbatim avec dégradation adaptative sous budget
        ...
        Logger.debug(
            ...
            f"(verbatim={len(recent_msgs)} msgs, timeline={bool(timeline_index)}, facts={bool(formatted_facts)})"
        )
